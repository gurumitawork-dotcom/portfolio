...
export default function Recognition() {
  return (
    <>
      <PageHero eyebrow="Recognition" title="Awards, societies & editorial service" />
              ...
              {AWARDS.map((a, i) => {
                ...
                return (
                  <div key={a.title} className="px-5 sm:px-7 py-5 sm:py-6">
                    <Icon size={22} className="text-teal-700" strokeWidth={1.75} />
                    <p className="mt-4 font-serif text-2xl text-teal-800 tabular-nums">{a.year}</p>
        ...
        <div className="container-lg">
          <Reveal className="glass-card relative overflow-hidden">
            ...
            <div className="p-5 sm:p-8 sm:pl-10">
              ...
              <p className="mt-6 text-[11px] font-bold uppercase tracking-[0.14em] text-teal-700">Fellowship</p>
              <ul className="mt-3 divide-y divide-slate-900/[0.07]">
                {FELLOWSHIPS.map((f) => (
                  ...
                  >
                    <p className="font-serif text-2xl text-teal-800 tracking-tight">{f.mark}</p>
                    <p className="text-sm text-navy-900 sm:pt-1.5">{f.society}</p>
                  </li>
                ))}
              </ul>

              <p className="mt-8 text-[11px] font-bold uppercase tracking-[0.14em] text-teal-700">Membership</p>
            ...
            <p className="border-t border-slate-900/[0.07] px-5 sm:px-8 sm:pl-10 py-4 text-sm text-slate-600">
              <span className="text-[11px] font-bold uppercase tracking-[0.14em] text-teal-700 mr-3">
                Committee
              </span>
              {COMMITTEE}
            </p>
            ...
            <div className="border-t border-slate-900/[0.07] p-5 sm:p-8 sm:pl-10">
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {PEER_REVIEW_JOURNALS.map((j) => (
                  <span
                    key={j}
                    className="rounded-full bg-teal-50 border border-teal-200/80 px-3.5 py-1.5 text-xs text-navy-900"
                  >
                    {j}
                  </span>
                ))}
          ...
          <Reveal className="glass-card relative overflow-hidden">
            ...
            <div className="p-5 sm:p-8 sm:pl-10">
              ...
              <div className="mt-6 flex items-start gap-4">
                <Medal size={22} className="mt-1 shrink-0 text-teal-700" strokeWidth={1.75} />
                <div>
                ...
                {MEDALS.slice(1).map((m) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-teal-800 text-right">{subject}</span>
                    </li>
                  );
                })}
              </ul>
